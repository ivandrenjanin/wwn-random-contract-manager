...
interface CanvasBaseAmbientLightStatic
    extends Omit<typeof BaseAmbientLight, "new">,
        CanvasDocumentStatic {}
...
export default class AmbientLightDocument<
...
export default interface AmbientLightDocument<TParent extends Scene | null>
    extends CanvasBaseAmbientLight<TParent> {
